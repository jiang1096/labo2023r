...
PARAM <- list()
PARAM$experimento <- "AE7410"

PARAM$exp_input <- "AD7310"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202001, 201912,
  201911, 201910, 201909, 201908, 201907
)

PARAM$train$training <- c(
  202101, 202012, 202011,
  202010, 202009, 202001, 201912, 201911, 201910, 201909, 201908, 201907,
  201906, 201905, 201904, 201903
)

PARAM$train$validation <- c(202105, 202102)
PARAM$train$testing <- c(202106, 202104, 202103)
...
PARAM$train$semilla <- 702337 # cambiar por su propia semilla  !!!
